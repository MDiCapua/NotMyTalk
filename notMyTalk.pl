...
s(S=>S1, GapInfo) -->
		[if],
		[someone],
		vp(finite, X^S, GapInfo, Num),
		[then],
		[he],
		vp(finite, X^S1, GapInfo, Num).
...
det( all, (X^S1)^(X^S2)^ all(X,S1=>S2), sg ).
det( a, (X^S1)^(X^S2)^exists(X,S1&S2), sg ).
det( an, (X^S1)^(X^S2)^exists(X,S1&S2), sg ).
...
aux( to, 	infinitival/nonfinite, 	VP^ to 		).
aux( does,  finite/nonfinite, 		VP^ does		).
aux( do, 	finite/nonfinite, 		VP^ do 		).
aux( did, 	finite/nonfinite, 		VP^ did 		).
aux( can, 	finite/nonfinite, 		VP^ can 		).
